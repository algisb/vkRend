...
.set PHYS_DEV_OFFSET_INST_DISPATCH   , 680     # The offset of 'phys_dev_ext' within in 'loader_instance_dispatch_table' struct
...
.set DISPATCH_OFFSET_ICD_TERM        , 808     # The offset of 'phys_dev_ext' within a 'loader_icd_term' struct
.set FUNC_NAME_OFFSET_HASH           , 0       # The offset of 'func_name' within a 'loader_dispatch_hash_entry' struct
.set EXT_OFFSET_DEVICE_DISPATCH      , 2752    # The offset of 'ext_dispatch' within a 'loader_dev_dispatch_table' struct
