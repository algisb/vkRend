...
inline void dump_vkBindAccelerationStructureMemoryNVX(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, uint32_t bindInfoCount, const VkBindAccelerationStructureMemoryInfoNVX* pBindInfos)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
    {
    case ApiDumpFormat::Text:
        dump_text_vkBindAccelerationStructureMemoryNVX(dump_inst, result, device, bindInfoCount, pBindInfos);
        break;
    case ApiDumpFormat::Html:
        dump_html_vkBindAccelerationStructureMemoryNVX(dump_inst, result, device, bindInfoCount, pBindInfos);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
inline void dump_vkCreateRaytracingPipelinesNVX(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkPipelineCache pipelineCache, uint32_t createInfoCount, const VkRaytracingPipelineCreateInfoNVX* pCreateInfos, const VkAllocationCallbacks* pAllocator, VkPipeline* pPipelines)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
    {
    case ApiDumpFormat::Text:
        dump_text_vkCreateRaytracingPipelinesNVX(dump_inst, result, device, pipelineCache, createInfoCount, pCreateInfos, pAllocator, pPipelines);
        break;
    case ApiDumpFormat::Html:
        dump_html_vkCreateRaytracingPipelinesNVX(dump_inst, result, device, pipelineCache, createInfoCount, pCreateInfos, pAllocator, pPipelines);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
inline void dump_vkGetRaytracingShaderHandlesNVX(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkPipeline pipeline, uint32_t firstGroup, uint32_t groupCount, size_t dataSize, void* pData)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
    {
    case ApiDumpFormat::Text:
        dump_text_vkGetRaytracingShaderHandlesNVX(dump_inst, result, device, pipeline, firstGroup, groupCount, dataSize, pData);
        break;
    case ApiDumpFormat::Html:
        dump_html_vkGetRaytracingShaderHandlesNVX(dump_inst, result, device, pipeline, firstGroup, groupCount, dataSize, pData);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
inline void dump_vkGetAccelerationStructureHandleNVX(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkAccelerationStructureNVX accelerationStructure, size_t dataSize, void* pData)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
    {
    case ApiDumpFormat::Text:
        dump_text_vkGetAccelerationStructureHandleNVX(dump_inst, result, device, accelerationStructure, dataSize, pData);
        break;
    case ApiDumpFormat::Html:
        dump_html_vkGetAccelerationStructureHandleNVX(dump_inst, result, device, accelerationStructure, dataSize, pData);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
inline void dump_vkCompileDeferredNVX(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkPipeline pipeline, uint32_t shader)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
    {
    case ApiDumpFormat::Text:
        dump_text_vkCompileDeferredNVX(dump_inst, result, device, pipeline, shader);
        break;
    case ApiDumpFormat::Html:
        dump_html_vkCompileDeferredNVX(dump_inst, result, device, pipeline, shader);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
inline void dump_vkCreateAccelerationStructureNVX(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, const VkAccelerationStructureCreateInfoNVX* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkAccelerationStructureNVX* pAccelerationStructure)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
    {
    case ApiDumpFormat::Text:
        dump_text_vkCreateAccelerationStructureNVX(dump_inst, result, device, pCreateInfo, pAllocator, pAccelerationStructure);
        break;
    case ApiDumpFormat::Html:
        dump_html_vkCreateAccelerationStructureNVX(dump_inst, result, device, pCreateInfo, pAllocator, pAccelerationStructure);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
inline void dump_vkCmdBuildAccelerationStructureNVX(ApiDumpInstance& dump_inst, VkCommandBuffer cmdBuf, VkAccelerationStructureTypeNVX type, uint32_t instanceCount, VkBuffer instanceData, VkDeviceSize instanceOffset, uint32_t geometryCount, const VkGeometryNVX* pGeometries, VkBuildAccelerationStructureFlagsNVX flags, VkBool32 update, VkAccelerationStructureNVX dst, VkAccelerationStructureNVX src, VkBuffer scratch, VkDeviceSize scratchOffset)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
    {
    case ApiDumpFormat::Text:
        dump_text_vkCmdBuildAccelerationStructureNVX(dump_inst, cmdBuf, type, instanceCount, instanceData, instanceOffset, geometryCount, pGeometries, flags, update, dst, src, scratch, scratchOffset);
        break;
    case ApiDumpFormat::Html:
        dump_html_vkCmdBuildAccelerationStructureNVX(dump_inst, cmdBuf, type, instanceCount, instanceData, instanceOffset, geometryCount, pGeometries, flags, update, dst, src, scratch, scratchOffset);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
inline void dump_vkCmdCopyAccelerationStructureNVX(ApiDumpInstance& dump_inst, VkCommandBuffer cmdBuf, VkAccelerationStructureNVX dst, VkAccelerationStructureNVX src, VkCopyAccelerationStructureModeNVX mode)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
    {
    case ApiDumpFormat::Text:
        dump_text_vkCmdCopyAccelerationStructureNVX(dump_inst, cmdBuf, dst, src, mode);
        break;
    case ApiDumpFormat::Html:
        dump_html_vkCmdCopyAccelerationStructureNVX(dump_inst, cmdBuf, dst, src, mode);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
inline void dump_vkCmdTraceRaysNVX(ApiDumpInstance& dump_inst, VkCommandBuffer cmdBuf, VkBuffer raygenShaderBindingTableBuffer, VkDeviceSize raygenShaderBindingOffset, VkBuffer missShaderBindingTableBuffer, VkDeviceSize missShaderBindingOffset, VkDeviceSize missShaderBindingStride, VkBuffer hitShaderBindingTableBuffer, VkDeviceSize hitShaderBindingOffset, VkDeviceSize hitShaderBindingStride, uint32_t width, uint32_t height)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
    {
    case ApiDumpFormat::Text:
        dump_text_vkCmdTraceRaysNVX(dump_inst, cmdBuf, raygenShaderBindingTableBuffer, raygenShaderBindingOffset, missShaderBindingTableBuffer, missShaderBindingOffset, missShaderBindingStride, hitShaderBindingTableBuffer, hitShaderBindingOffset, hitShaderBindingStride, width, height);
        break;
    case ApiDumpFormat::Html:
        dump_html_vkCmdTraceRaysNVX(dump_inst, cmdBuf, raygenShaderBindingTableBuffer, raygenShaderBindingOffset, missShaderBindingTableBuffer, missShaderBindingOffset, missShaderBindingStride, hitShaderBindingTableBuffer, hitShaderBindingOffset, hitShaderBindingStride, width, height);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
inline void dump_vkCmdWriteAccelerationStructurePropertiesNVX(ApiDumpInstance& dump_inst, VkCommandBuffer cmdBuf, VkAccelerationStructureNVX accelerationStructure, VkQueryType queryType, VkQueryPool queryPool, uint32_t query)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
    {
    case ApiDumpFormat::Text:
        dump_text_vkCmdWriteAccelerationStructurePropertiesNVX(dump_inst, cmdBuf, accelerationStructure, queryType, queryPool, query);
        break;
    case ApiDumpFormat::Html:
        dump_html_vkCmdWriteAccelerationStructurePropertiesNVX(dump_inst, cmdBuf, accelerationStructure, queryType, queryPool, query);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
inline void dump_vkDestroyAccelerationStructureNVX(ApiDumpInstance& dump_inst, VkDevice device, VkAccelerationStructureNVX accelerationStructure, const VkAllocationCallbacks* pAllocator)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
    {
    case ApiDumpFormat::Text:
        dump_text_vkDestroyAccelerationStructureNVX(dump_inst, device, accelerationStructure, pAllocator);
        break;
    case ApiDumpFormat::Html:
        dump_html_vkDestroyAccelerationStructureNVX(dump_inst, device, accelerationStructure, pAllocator);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
inline void dump_vkGetAccelerationStructureScratchMemoryRequirementsNVX(ApiDumpInstance& dump_inst, VkDevice device, const VkAccelerationStructureMemoryRequirementsInfoNVX* pInfo, VkMemoryRequirements2KHR* pMemoryRequirements)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
    {
    case ApiDumpFormat::Text:
        dump_text_vkGetAccelerationStructureScratchMemoryRequirementsNVX(dump_inst, device, pInfo, pMemoryRequirements);
        break;
    case ApiDumpFormat::Html:
        dump_html_vkGetAccelerationStructureScratchMemoryRequirementsNVX(dump_inst, device, pInfo, pMemoryRequirements);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
inline void dump_vkGetAccelerationStructureMemoryRequirementsNVX(ApiDumpInstance& dump_inst, VkDevice device, const VkAccelerationStructureMemoryRequirementsInfoNVX* pInfo, VkMemoryRequirements2KHR* pMemoryRequirements)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
    {
    case ApiDumpFormat::Text:
        dump_text_vkGetAccelerationStructureMemoryRequirementsNVX(dump_inst, device, pInfo, pMemoryRequirements);
        break;
    case ApiDumpFormat::Html:
        dump_html_vkGetAccelerationStructureMemoryRequirementsNVX(dump_inst, device, pInfo, pMemoryRequirements);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkBindAccelerationStructureMemoryNVX(VkDevice device, uint32_t bindInfoCount, const VkBindAccelerationStructureMemoryInfoNVX* pBindInfos)
{
    VkResult result = device_dispatch_table(device)->BindAccelerationStructureMemoryNVX(device, bindInfoCount, pBindInfos);
    
    dump_vkBindAccelerationStructureMemoryNVX(ApiDumpInstance::current(), result, device, bindInfoCount, pBindInfos);
    return result;
}
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkCreateRaytracingPipelinesNVX(VkDevice device, VkPipelineCache pipelineCache, uint32_t createInfoCount, const VkRaytracingPipelineCreateInfoNVX* pCreateInfos, const VkAllocationCallbacks* pAllocator, VkPipeline* pPipelines)
{
    VkResult result = device_dispatch_table(device)->CreateRaytracingPipelinesNVX(device, pipelineCache, createInfoCount, pCreateInfos, pAllocator, pPipelines);
    
    dump_vkCreateRaytracingPipelinesNVX(ApiDumpInstance::current(), result, device, pipelineCache, createInfoCount, pCreateInfos, pAllocator, pPipelines);
    return result;
}
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkGetRaytracingShaderHandlesNVX(VkDevice device, VkPipeline pipeline, uint32_t firstGroup, uint32_t groupCount, size_t dataSize, void* pData)
{
    VkResult result = device_dispatch_table(device)->GetRaytracingShaderHandlesNVX(device, pipeline, firstGroup, groupCount, dataSize, pData);
    
    dump_vkGetRaytracingShaderHandlesNVX(ApiDumpInstance::current(), result, device, pipeline, firstGroup, groupCount, dataSize, pData);
    return result;
}
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkGetAccelerationStructureHandleNVX(VkDevice device, VkAccelerationStructureNVX accelerationStructure, size_t dataSize, void* pData)
{
    VkResult result = device_dispatch_table(device)->GetAccelerationStructureHandleNVX(device, accelerationStructure, dataSize, pData);
    
    dump_vkGetAccelerationStructureHandleNVX(ApiDumpInstance::current(), result, device, accelerationStructure, dataSize, pData);
    return result;
}
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkCompileDeferredNVX(VkDevice device, VkPipeline pipeline, uint32_t shader)
{
    VkResult result = device_dispatch_table(device)->CompileDeferredNVX(device, pipeline, shader);
    
    dump_vkCompileDeferredNVX(ApiDumpInstance::current(), result, device, pipeline, shader);
    return result;
}
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkCreateAccelerationStructureNVX(VkDevice device, const VkAccelerationStructureCreateInfoNVX* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkAccelerationStructureNVX* pAccelerationStructure)
{
    VkResult result = device_dispatch_table(device)->CreateAccelerationStructureNVX(device, pCreateInfo, pAllocator, pAccelerationStructure);
    
    dump_vkCreateAccelerationStructureNVX(ApiDumpInstance::current(), result, device, pCreateInfo, pAllocator, pAccelerationStructure);
    return result;
}
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkCmdBuildAccelerationStructureNVX(VkCommandBuffer cmdBuf, VkAccelerationStructureTypeNVX type, uint32_t instanceCount, VkBuffer instanceData, VkDeviceSize instanceOffset, uint32_t geometryCount, const VkGeometryNVX* pGeometries, VkBuildAccelerationStructureFlagsNVX flags, VkBool32 update, VkAccelerationStructureNVX dst, VkAccelerationStructureNVX src, VkBuffer scratch, VkDeviceSize scratchOffset)
{
    device_dispatch_table(cmdBuf)->CmdBuildAccelerationStructureNVX(cmdBuf, type, instanceCount, instanceData, instanceOffset, geometryCount, pGeometries, flags, update, dst, src, scratch, scratchOffset);
    
    dump_vkCmdBuildAccelerationStructureNVX(ApiDumpInstance::current(), cmdBuf, type, instanceCount, instanceData, instanceOffset, geometryCount, pGeometries, flags, update, dst, src, scratch, scratchOffset);
}
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkCmdCopyAccelerationStructureNVX(VkCommandBuffer cmdBuf, VkAccelerationStructureNVX dst, VkAccelerationStructureNVX src, VkCopyAccelerationStructureModeNVX mode)
{
    device_dispatch_table(cmdBuf)->CmdCopyAccelerationStructureNVX(cmdBuf, dst, src, mode);
    
    dump_vkCmdCopyAccelerationStructureNVX(ApiDumpInstance::current(), cmdBuf, dst, src, mode);
}
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkCmdTraceRaysNVX(VkCommandBuffer cmdBuf, VkBuffer raygenShaderBindingTableBuffer, VkDeviceSize raygenShaderBindingOffset, VkBuffer missShaderBindingTableBuffer, VkDeviceSize missShaderBindingOffset, VkDeviceSize missShaderBindingStride, VkBuffer hitShaderBindingTableBuffer, VkDeviceSize hitShaderBindingOffset, VkDeviceSize hitShaderBindingStride, uint32_t width, uint32_t height)
{
    device_dispatch_table(cmdBuf)->CmdTraceRaysNVX(cmdBuf, raygenShaderBindingTableBuffer, raygenShaderBindingOffset, missShaderBindingTableBuffer, missShaderBindingOffset, missShaderBindingStride, hitShaderBindingTableBuffer, hitShaderBindingOffset, hitShaderBindingStride, width, height);
    
    dump_vkCmdTraceRaysNVX(ApiDumpInstance::current(), cmdBuf, raygenShaderBindingTableBuffer, raygenShaderBindingOffset, missShaderBindingTableBuffer, missShaderBindingOffset, missShaderBindingStride, hitShaderBindingTableBuffer, hitShaderBindingOffset, hitShaderBindingStride, width, height);
}
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkCmdWriteAccelerationStructurePropertiesNVX(VkCommandBuffer cmdBuf, VkAccelerationStructureNVX accelerationStructure, VkQueryType queryType, VkQueryPool queryPool, uint32_t query)
{
    device_dispatch_table(cmdBuf)->CmdWriteAccelerationStructurePropertiesNVX(cmdBuf, accelerationStructure, queryType, queryPool, query);
    
    dump_vkCmdWriteAccelerationStructurePropertiesNVX(ApiDumpInstance::current(), cmdBuf, accelerationStructure, queryType, queryPool, query);
}
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkDestroyAccelerationStructureNVX(VkDevice device, VkAccelerationStructureNVX accelerationStructure, const VkAllocationCallbacks* pAllocator)
{
    device_dispatch_table(device)->DestroyAccelerationStructureNVX(device, accelerationStructure, pAllocator);
    
    dump_vkDestroyAccelerationStructureNVX(ApiDumpInstance::current(), device, accelerationStructure, pAllocator);
}
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkGetAccelerationStructureScratchMemoryRequirementsNVX(VkDevice device, const VkAccelerationStructureMemoryRequirementsInfoNVX* pInfo, VkMemoryRequirements2KHR* pMemoryRequirements)
{
    device_dispatch_table(device)->GetAccelerationStructureScratchMemoryRequirementsNVX(device, pInfo, pMemoryRequirements);
    
    dump_vkGetAccelerationStructureScratchMemoryRequirementsNVX(ApiDumpInstance::current(), device, pInfo, pMemoryRequirements);
}
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkGetAccelerationStructureMemoryRequirementsNVX(VkDevice device, const VkAccelerationStructureMemoryRequirementsInfoNVX* pInfo, VkMemoryRequirements2KHR* pMemoryRequirements)
{
    device_dispatch_table(device)->GetAccelerationStructureMemoryRequirementsNVX(device, pInfo, pMemoryRequirements);
    
    dump_vkGetAccelerationStructureMemoryRequirementsNVX(ApiDumpInstance::current(), device, pInfo, pMemoryRequirements);
}
...
VK_LAYER_EXPORT VKAPI_ATTR PFN_vkVoidFunction VKAPI_CALL vkGetDeviceProcAddr(VkDevice device, const char* pName)
{
    ...
    if(strcmp(pName, "vkBindAccelerationStructureMemoryNVX") == 0)
        return reinterpret_cast<PFN_vkVoidFunction>(vkBindAccelerationStructureMemoryNVX);
    if(strcmp(pName, "vkCmdBuildAccelerationStructureNVX") == 0)
        return reinterpret_cast<PFN_vkVoidFunction>(vkCmdBuildAccelerationStructureNVX);
    ...
    if(strcmp(pName, "vkCmdCopyAccelerationStructureNVX") == 0)
        return reinterpret_cast<PFN_vkVoidFunction>(vkCmdCopyAccelerationStructureNVX);
    ...
    if(strcmp(pName, "vkCmdTraceRaysNVX") == 0)
        return reinterpret_cast<PFN_vkVoidFunction>(vkCmdTraceRaysNVX);
    ...
    if(strcmp(pName, "vkCreateRaytracingPipelinesNVX") == 0)
        return reinterpret_cast<PFN_vkVoidFunction>(vkCreateRaytracingPipelinesNVX);
    ...
    if(strcmp(pName, "vkGetRaytracingShaderHandlesNVX") == 0)
        return reinterpret_cast<PFN_vkVoidFunction>(vkGetRaytracingShaderHandlesNVX);
    ...
    if(strcmp(pName, "vkCmdWriteAccelerationStructurePropertiesNVX") == 0)
        return reinterpret_cast<PFN_vkVoidFunction>(vkCmdWriteAccelerationStructurePropertiesNVX);
    if(strcmp(pName, "vkGetAccelerationStructureHandleNVX") == 0)
        return reinterpret_cast<PFN_vkVoidFunction>(vkGetAccelerationStructureHandleNVX);
    ...
    if(strcmp(pName, "vkCompileDeferredNVX") == 0)
        return reinterpret_cast<PFN_vkVoidFunction>(vkCompileDeferredNVX);
    ...
    if(strcmp(pName, "vkCreateAccelerationStructureNVX") == 0)
        return reinterpret_cast<PFN_vkVoidFunction>(vkCreateAccelerationStructureNVX);
    ...
    if(strcmp(pName, "vkDestroyAccelerationStructureNVX") == 0)
        return reinterpret_cast<PFN_vkVoidFunction>(vkDestroyAccelerationStructureNVX);
...
#endif // VK_USE_PLATFORM_ANDROID_KHR
    if(strcmp(pName, "vkGetAccelerationStructureScratchMemoryRequirementsNVX") == 0)
        return reinterpret_cast<PFN_vkVoidFunction>(vkGetAccelerationStructureScratchMemoryRequirementsNVX);
    ...
    if(strcmp(pName, "vkGetAccelerationStructureMemoryRequirementsNVX") == 0)
        return reinterpret_cast<PFN_vkVoidFunction>(vkGetAccelerationStructureMemoryRequirementsNVX);
